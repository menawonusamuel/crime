    ...
    <div class="w3-quarter">
      <div class="w3-container  bg-primary w3-padding-16">
        ...
        <div class="w3-right">
          ...
          $localCom = $conn->getBySql("SELECT COUNT(police_id) FROM crimes INNER JOIN police_command_areas on crimes.crime_street = police_command_areas.street WHERE crimes.police_id<>0 ");
   ...
   ?>
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-orange w3-text-white w3-padding-16">
        ...
        <div class="w3-right">
          <?php
        $localCom = $conn->getBySql("SELECT COUNT(police_id) FROM crimes INNER JOIN police_command_areas on crimes.crime_street = police_command_areas.street WHERE  crimes.status='closed' ");
        $row =$localCom->fetch_assoc();
          echo "<h3>" . $row['COUNT(police_id)'] . "</h3>";
          ?>
        </div>
