...
<div class="w3-container sticky fixed-top w3-dark-blue bg-primary w3-large w3-padding" style="z-index:4">
    ...
    <span class="w3-right "><a href ="http://localhost/crime/pol_dash/pol_dashboard.php?id=<?php
        if(isset($_GET['id'])){
            echo $_GET['id'];
        }else{
            echo " ";
        ...
        ?>" class="btn btn-secondary">Go to Your Dashboard</a></span>
</div>
...
<nav class="w3-sidenav w3-collapse w3-dark-grey w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
    ...
    <a href="pol_dept/index.php" class="w3-padding-16 w3-hide-large w3-dark-grey w3-hover-black" onclick="w3_close()" title="close menu"><i class="fa fa-remove fa-fw"></i>  Close Menu</a>
    <a href="http://localhost/crime/pol_dept/index.php?id=<?php
    if(isset($_GET['id'])){
        echo $_GET['id'];
    }else{
        echo " ";
    ...
    <a href="http://localhost/crime/pol_dept/pol_complaints.php?id=<?php
    if(isset($_GET['id'])){
        echo $_GET['id'];
    }else{
        echo " ";
    ...
    ?>" class="w3-padding "  aria-expanded="true" aria-controls="collapseOne" ><i class="fa fa-eye fa-fw"></i>   Complains Assigned</a>

    <a href="http://localhost/crime/pol_dept/pol_police.php?id=<?php
    if(isset($_GET['id'])){
        echo $_GET['id'];
    }else{
        echo " ";
    ...
    ?>" class="w3-padding "  aria-expanded="true" aria-controls="collapseOne" ><i class="fa fa-eye fa-fw"></i>   View Police</a>
